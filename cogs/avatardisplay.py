        ...
        try:
            ...
            if hasattr(user, 'joined_at') and user.joined_at:
                ...
                if hasattr(user, 'activity') and user.activity:
                    ...
                    context_info.append(f"**Activity:** {activity_type.get(user.activity.type, '❓')} {activity_name}")
                
                # Highest role color
                if hasattr(user, 'top_role') and user.top_role and user.top_role.color != discord.Color.default():
